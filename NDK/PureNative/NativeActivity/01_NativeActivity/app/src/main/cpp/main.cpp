...
#define LOGI(...) ((void)__android_log_print(ANDROID_LOG_INFO, "MPD:native-activity", __VA_ARGS__))
#define LOGW(...) ((void)__android_log_print(ANDROID_LOG_WARN, "MPD:native-activity", __VA_ARGS__))
 ...
 static void engine_draw_frame(struct engine* engine)
{
     ...
     //just fill the screen with color;
...
ASensorManager* AcquireASensorManagerInstance(android_app* app)
{
    ...
    if(getInstanceForPackageFunc) {
        ...
        jclass android_context_Context = env->GetObjectClass(app->activity->clazz);
        jmethodID midGetPacageName = env->GetMethodID(android_context_Context,
                                                      "getPackageName",
                                                      "()Ljava/lang/String;");
